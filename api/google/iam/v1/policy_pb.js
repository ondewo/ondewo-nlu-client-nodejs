		...
		var f,
			obj = {
				...
				bindingsList: jspb.Message.toObjectList(
					msg.getBindingsList(),
					proto.google.iam.v1.Binding.toObject,
					includeInstance
				),
...
proto.google.iam.v1.Policy.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(4, f, proto.google.iam.v1.Binding.serializeBinaryToWriter);
	}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.google.iam.v1.PolicyDelta.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				bindingDeltasList: jspb.Message.toObjectList(
					msg.getBindingDeltasList(),
					proto.google.iam.v1.BindingDelta.toObject,
					includeInstance
				)
			};
...
proto.google.iam.v1.PolicyDelta.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.google.iam.v1.BindingDelta.serializeBinaryToWriter);
	}
};
