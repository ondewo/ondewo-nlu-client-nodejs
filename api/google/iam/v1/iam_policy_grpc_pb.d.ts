...
interface IIAMPolicyService_ISetIamPolicy
	extends grpc.MethodDefinition<google_iam_v1_iam_policy_pb.SetIamPolicyRequest, google_iam_v1_policy_pb.Policy> {
...
interface IIAMPolicyService_IGetIamPolicy
	extends grpc.MethodDefinition<google_iam_v1_iam_policy_pb.GetIamPolicyRequest, google_iam_v1_policy_pb.Policy> {
...
interface IIAMPolicyService_ITestIamPermissions
...
export interface IIAMPolicyServer {
	...
	testIamPermissions: grpc.handleUnaryCall<
		google_iam_v1_iam_policy_pb.TestIamPermissionsRequest,
		google_iam_v1_iam_policy_pb.TestIamPermissionsResponse
	>;
}
...
export interface IIAMPolicyClient {
	setIamPolicy(
		...
		callback: (error: grpc.ServiceError | null, response: google_iam_v1_policy_pb.Policy) => void
	...
	testIamPermissions(
		...
		callback: (
			...
			response: google_iam_v1_iam_policy_pb.TestIamPermissionsResponse
		) => void
	): grpc.ClientUnaryCall;
	testIamPermissions(
		request: google_iam_v1_iam_policy_pb.TestIamPermissionsRequest,
