...
proto.google.logging.v2.LogEntry.prototype.getPayloadCase = function () {
	return /** @type {proto.google.logging.v2.LogEntry.PayloadCase} */ (
		jspb.Message.computeOneofCase(this, proto.google.logging.v2.LogEntry.oneofGroups_[0])
	);
};
	...
	proto.google.logging.v2.LogEntry.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				resource:
					(f = msg.getResource()) && google_api_monitored_resource_pb.MonitoredResource.toObject(includeInstance, f),
				...
				receiveTimestamp:
					(f = msg.getReceiveTimestamp()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
				severity: jspb.Message.getFieldWithDefault(msg, 10, 0),
				insertId: jspb.Message.getFieldWithDefault(msg, 4, ''),
				httpRequest:
					(f = msg.getHttpRequest()) && google_logging_type_http_request_pb.HttpRequest.toObject(includeInstance, f),
				labelsMap: (f = msg.getLabelsMap()) ? f.toObject(includeInstance, undefined) : [],
				metadata:
					(f = msg.getMetadata()) &&
					google_api_monitored_resource_pb.MonitoredResourceMetadata.toObject(includeInstance, f),
				...
				sourceLocation:
					(f = msg.getSourceLocation()) && proto.google.logging.v2.LogEntrySourceLocation.toObject(includeInstance, f)
			};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 25:
				...
				reader.readMessage(
					value,
					google_api_monitored_resource_pb.MonitoredResourceMetadata.deserializeBinaryFromReader
				);
...
proto.google.logging.v2.LogEntry.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(8, f, google_api_monitored_resource_pb.MonitoredResource.serializeBinaryToWriter);
	}
	...
	if (f != null) {
		writer.writeMessage(7, f, google_logging_type_http_request_pb.HttpRequest.serializeBinaryToWriter);
	}
	...
	if (f != null) {
		writer.writeMessage(25, f, google_api_monitored_resource_pb.MonitoredResourceMetadata.serializeBinaryToWriter);
	}
	f = message.getOperation();
	if (f != null) {
		writer.writeMessage(15, f, proto.google.logging.v2.LogEntryOperation.serializeBinaryToWriter);
	}
	f = message.getTrace();
	if (f.length > 0) {
	...
	if (f != null) {
		writer.writeMessage(23, f, proto.google.logging.v2.LogEntrySourceLocation.serializeBinaryToWriter);
	}
};
