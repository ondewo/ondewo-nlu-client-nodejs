		...
		var f,
			obj = {
				authorization:
					...
					google_api_experimental_authorization_config_pb.AuthorizationConfig.toObject(includeInstance, f)
			};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			case 8:
				...
				reader.readMessage(
					value,
					google_api_experimental_authorization_config_pb.AuthorizationConfig.deserializeBinaryFromReader
				);
