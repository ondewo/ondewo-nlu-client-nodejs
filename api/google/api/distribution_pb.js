...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.google.api.Distribution.BucketOptions.Exponential.displayName =
		'proto.google.api.Distribution.BucketOptions.Exponential';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.google.api.Distribution.BucketOptions.Explicit = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.google.api.Distribution.BucketOptions.Explicit.repeatedFields_,
		null
	);
};
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.google.api.Distribution.BucketOptions.Explicit.displayName =
		'proto.google.api.Distribution.BucketOptions.Explicit';
}
	...
	proto.google.api.Distribution.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				bucketOptions:
					(f = msg.getBucketOptions()) && proto.google.api.Distribution.BucketOptions.toObject(includeInstance, f),
...
proto.google.api.Distribution.BucketOptions.prototype.getOptionsCase = function () {
	return /** @type {proto.google.api.Distribution.BucketOptions.OptionsCase} */ (
		jspb.Message.computeOneofCase(this, proto.google.api.Distribution.BucketOptions.oneofGroups_[0])
	);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.google.api.Distribution.BucketOptions.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				linearBuckets:
					(f = msg.getLinearBuckets()) &&
					proto.google.api.Distribution.BucketOptions.Linear.toObject(includeInstance, f),
				exponentialBuckets:
					(f = msg.getExponentialBuckets()) &&
					proto.google.api.Distribution.BucketOptions.Exponential.toObject(includeInstance, f),
				explicitBuckets:
					(f = msg.getExplicitBuckets()) &&
					proto.google.api.Distribution.BucketOptions.Explicit.toObject(includeInstance, f)
			};
