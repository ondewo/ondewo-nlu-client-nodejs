		...
		var f,
			obj = {
				consumerDestinationsList: jspb.Message.toObjectList(
					...
					proto.google.api.Billing.BillingDestination.toObject,
					includeInstance
				)
			};
...
proto.google.api.Billing.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(8, f, proto.google.api.Billing.BillingDestination.serializeBinaryToWriter);
	}
};
...
proto.google.api.Billing.prototype.addConsumerDestinations = function (opt_value, opt_index) {
	return jspb.Message.addToRepeatedWrapperField(
		...
		8,
		opt_value,
		proto.google.api.Billing.BillingDestination,
		opt_index
	);
};
