...
proto.google.api.Monitoring.MonitoringDestination = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.google.api.Monitoring.MonitoringDestination.repeatedFields_,
		null
	);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.google.api.Monitoring.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				producerDestinationsList: jspb.Message.toObjectList(
					msg.getProducerDestinationsList(),
					proto.google.api.Monitoring.MonitoringDestination.toObject,
					includeInstance
				),
				consumerDestinationsList: jspb.Message.toObjectList(
					msg.getConsumerDestinationsList(),
					proto.google.api.Monitoring.MonitoringDestination.toObject,
					includeInstance
				)
			};
...
proto.google.api.Monitoring.prototype.addProducerDestinations = function (opt_value, opt_index) {
	return jspb.Message.addToRepeatedWrapperField(
		...
		1,
		opt_value,
		proto.google.api.Monitoring.MonitoringDestination,
		opt_index
	);
};
