		...
		var f,
			obj = {
				...
				methodsList: jspb.Message.toObjectList(
					msg.getMethodsList(),
					proto.google.protobuf.Method.toObject,
					includeInstance
				),
				optionsList: jspb.Message.toObjectList(
					msg.getOptionsList(),
					google_protobuf_type_pb.Option.toObject,
					includeInstance
				),
				version: jspb.Message.getFieldWithDefault(msg, 4, ''),
				sourceContext:
					(f = msg.getSourceContext()) && google_protobuf_source_context_pb.SourceContext.toObject(includeInstance, f),
				mixinsList: jspb.Message.toObjectList(
					msg.getMixinsList(),
					proto.google.protobuf.Mixin.toObject,
					includeInstance
				),
...
proto.google.protobuf.Api.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(2, f, proto.google.protobuf.Method.serializeBinaryToWriter);
	}
	f = message.getOptionsList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(3, f, google_protobuf_type_pb.Option.serializeBinaryToWriter);
	}
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(6, f, proto.google.protobuf.Mixin.serializeBinaryToWriter);
	}
	f = message.getSyntax();
	if (f !== 0.0) {
...
proto.google.protobuf.Method.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getOptionsList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(6, f, google_protobuf_type_pb.Option.serializeBinaryToWriter);
	}
	f = message.getSyntax();
	if (f !== 0.0) {
		writer.writeEnum(7, f);
