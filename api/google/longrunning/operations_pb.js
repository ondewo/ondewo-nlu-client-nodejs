...
proto.google.longrunning.Operation.prototype.getResultCase = function () {
	return /** @type {proto.google.longrunning.Operation.ResultCase} */ (
		jspb.Message.computeOneofCase(this, proto.google.longrunning.Operation.oneofGroups_[0])
	);
};
		...
		var f,
			obj = {
				operationsList: jspb.Message.toObjectList(
					...
					proto.google.longrunning.Operation.toObject,
					includeInstance
				),
...
proto.google.longrunning.ListOperationsResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.google.longrunning.Operation.serializeBinaryToWriter);
	}
