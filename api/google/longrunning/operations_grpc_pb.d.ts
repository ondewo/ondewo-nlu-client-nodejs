...
interface IOperationsService_IListOperations
	extends grpc.MethodDefinition<
		google_longrunning_operations_pb.ListOperationsRequest,
		google_longrunning_operations_pb.ListOperationsResponse
	> {
...
interface IOperationsService_IDeleteOperation
	extends grpc.MethodDefinition<
		google_longrunning_operations_pb.DeleteOperationRequest,
...
interface IOperationsService_ICancelOperation
	extends grpc.MethodDefinition<
		google_longrunning_operations_pb.CancelOperationRequest,
		google_protobuf_empty_pb.Empty
	> {
...
export interface IOperationsClient {
	listOperations(
		...
		callback: (
			...
			response: google_longrunning_operations_pb.ListOperationsResponse
		) => void
