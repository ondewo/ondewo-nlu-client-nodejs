...
proto.google.cloud.support.common.IssueTaxonomy.Component = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.google.cloud.support.common.IssueTaxonomy.Component.repeatedFields_,
		null
	);
};
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.google.cloud.support.common.IssueTaxonomy.Component.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.google.cloud.support.common.IssueTaxonomy.Category.displayName =
...
proto.google.cloud.support.common.SupportAccount.prototype.getState = function () {
	return /** @type {!proto.google.cloud.support.common.SupportAccount.State} */ (
...
proto.google.cloud.support.common.SupportAccount.prototype.getPricingModel = function () {
	return /** @type {!proto.google.cloud.support.common.SupportAccount.PricingModel} */ (
		...
		var f,
			obj = {
				...
				issuesList: jspb.Message.toObjectList(
					msg.getIssuesList(),
					proto.google.cloud.support.common.CustomerIssue.toObject,
					includeInstance
				),
...
proto.google.cloud.support.common.Case.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(10, f, proto.google.cloud.support.common.CustomerIssue.serializeBinaryToWriter);
	}
...
proto.google.cloud.support.common.Case.prototype.addIssues = function (opt_value, opt_index) {
	return jspb.Message.addToRepeatedWrapperField(
		...
		10,
		opt_value,
		proto.google.cloud.support.common.CustomerIssue,
		opt_index
	);
};
...
proto.google.cloud.support.common.Case.prototype.getPriority = function () {
	return /** @type {!proto.google.cloud.support.common.Case.Priority} */ (
...
proto.google.cloud.support.common.CustomerIssue.prototype.getState = function () {
	return /** @type {!proto.google.cloud.support.common.CustomerIssue.IssueState} */ (
...
proto.google.cloud.support.common.SupportRole.prototype.getRole = function () {
	return /** @type {!proto.google.cloud.support.common.SupportRole.Role} */ (
		jspb.Message.getFieldWithDefault(this, 2, 0)
	);
};
		...
		var f,
			obj = {
				categoriesMap: (f = msg.getCategoriesMap())
					? f.toObject(includeInstance, proto.google.cloud.support.common.IssueTaxonomy.Category.toObject)
					: []
			};
			...
			case 1:
				...
				reader.readMessage(value, function (message, reader) {
					jspb.Map.deserializeBinary(
						...
						proto.google.cloud.support.common.IssueTaxonomy.Category.deserializeBinaryFromReader,
						'',
						new proto.google.cloud.support.common.IssueTaxonomy.Category()
					);
				});
				break;
			default:
...
proto.google.cloud.support.common.IssueTaxonomy.serializeBinaryToWriter = function (message, writer) {
	...
	if (f && f.getLength() > 0) {
		f.serializeBinary(
			...
			proto.google.cloud.support.common.IssueTaxonomy.Category.serializeBinaryToWriter
		);
	}
};
	...
	proto.google.cloud.support.common.IssueTaxonomy.Component.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				subcomponentsList: jspb.Message.toObjectList(
					msg.getSubcomponentsList(),
					proto.google.cloud.support.common.IssueTaxonomy.Component.toObject,
					includeInstance
				)
			};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 4:
				...
				reader.readMessage(
					value,
					proto.google.cloud.support.common.IssueTaxonomy.Component.deserializeBinaryFromReader
				);
		...
		var f,
			obj = {
				...
				componentsMap: (f = msg.getComponentsMap())
					? f.toObject(includeInstance, proto.google.cloud.support.common.IssueTaxonomy.Component.toObject)
					: []
			};
			...
			case 2:
				...
				reader.readMessage(value, function (message, reader) {
					jspb.Map.deserializeBinary(
						...
						proto.google.cloud.support.common.IssueTaxonomy.Component.deserializeBinaryFromReader,
						'',
						new proto.google.cloud.support.common.IssueTaxonomy.Component()
					);
				});
				break;
			default:
...
proto.google.cloud.support.common.IssueTaxonomy.Category.prototype.getComponentsMap = function (opt_noLazyCreate) {
	return /** @type {!jspb.Map<string,!proto.google.cloud.support.common.IssueTaxonomy.Component>} */ (
		jspb.Message.getMapField(this, 2, opt_noLazyCreate, proto.google.cloud.support.common.IssueTaxonomy.Component)
	);
};
...
proto.google.cloud.support.common.IssueTaxonomy.prototype.getCategoriesMap = function (opt_noLazyCreate) {
	return /** @type {!jspb.Map<string,!proto.google.cloud.support.common.IssueTaxonomy.Category>} */ (
		jspb.Message.getMapField(this, 1, opt_noLazyCreate, proto.google.cloud.support.common.IssueTaxonomy.Category)
	);
};
