...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.google.cloud.websecurityscanner.v1alpha.ScanRun.displayName =
	...
	while (reader.nextField()) {
		...
		switch (field) {
			case 1:
				...
				break;
			case 2:
				var value = /** @type {!proto.google.cloud.websecurityscanner.v1alpha.ScanRun.ExecutionState} */ (
					reader.readEnum()
				);
				msg.setExecutionState(value);
				break;
			case 3:
				var value = /** @type {!proto.google.cloud.websecurityscanner.v1alpha.ScanRun.ResultState} */ (
					reader.readEnum()
				);
...
proto.google.cloud.websecurityscanner.v1alpha.ScanRun.prototype.getExecutionState = function () {
	return /** @type {!proto.google.cloud.websecurityscanner.v1alpha.ScanRun.ExecutionState} */ (
...
proto.google.cloud.websecurityscanner.v1alpha.ScanRun.prototype.getResultState = function () {
	return /** @type {!proto.google.cloud.websecurityscanner.v1alpha.ScanRun.ResultState} */ (
