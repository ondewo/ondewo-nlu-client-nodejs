...
proto.google.cloud.tasks.v2beta2.Task.prototype.getPayloadTypeCase = function () {
	return /** @type {proto.google.cloud.tasks.v2beta2.Task.PayloadTypeCase} */ (
		jspb.Message.computeOneofCase(this, proto.google.cloud.tasks.v2beta2.Task.oneofGroups_[0])
	);
};
		...
		var f,
			obj = {
				...
				appEngineHttpRequest:
					(f = msg.getAppEngineHttpRequest()) &&
					google_cloud_tasks_v2beta2_target_pb.AppEngineHttpRequest.toObject(includeInstance, f),
				pullMessage:
					(f = msg.getPullMessage()) && google_cloud_tasks_v2beta2_target_pb.PullMessage.toObject(includeInstance, f),
				scheduleTime:
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 3:
				...
				reader.readMessage(
					value,
					google_cloud_tasks_v2beta2_target_pb.AppEngineHttpRequest.deserializeBinaryFromReader
				);
...
proto.google.cloud.tasks.v2beta2.Task.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(3, f, google_cloud_tasks_v2beta2_target_pb.AppEngineHttpRequest.serializeBinaryToWriter);
	}
	f = message.getPullMessage();
	if (f != null) {
		writer.writeMessage(4, f, google_cloud_tasks_v2beta2_target_pb.PullMessage.serializeBinaryToWriter);
	}
	...
	f = message.getStatus();
	if (f != null) {
		writer.writeMessage(7, f, proto.google.cloud.tasks.v2beta2.TaskStatus.serializeBinaryToWriter);
	}
	f = message.getView();
	if (f !== 0.0) {
	...
	proto.google.cloud.tasks.v2beta2.TaskStatus.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				firstAttemptStatus:
					(f = msg.getFirstAttemptStatus()) &&
					proto.google.cloud.tasks.v2beta2.AttemptStatus.toObject(includeInstance, f),
				lastAttemptStatus:
					(f = msg.getLastAttemptStatus()) &&
					proto.google.cloud.tasks.v2beta2.AttemptStatus.toObject(includeInstance, f)
			};
...
proto.google.cloud.tasks.v2beta2.TaskStatus.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(3, f, proto.google.cloud.tasks.v2beta2.AttemptStatus.serializeBinaryToWriter);
	}
	f = message.getLastAttemptStatus();
	if (f != null) {
		writer.writeMessage(4, f, proto.google.cloud.tasks.v2beta2.AttemptStatus.serializeBinaryToWriter);
	}
};
		...
		var f,
			obj = {
				scheduleTime:
					(f = msg.getScheduleTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
				dispatchTime:
					(f = msg.getDispatchTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
				responseTime:
					(f = msg.getResponseTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
