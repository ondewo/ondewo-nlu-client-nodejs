...
proto.google.cloud.tasks.v2beta2.Queue.prototype.getTargetTypeCase = function () {
	return /** @type {proto.google.cloud.tasks.v2beta2.Queue.TargetTypeCase} */ (
		jspb.Message.computeOneofCase(this, proto.google.cloud.tasks.v2beta2.Queue.oneofGroups_[0])
	);
};
	...
	proto.google.cloud.tasks.v2beta2.Queue.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				appEngineHttpTarget:
					(f = msg.getAppEngineHttpTarget()) &&
					google_cloud_tasks_v2beta2_target_pb.AppEngineHttpTarget.toObject(includeInstance, f),
				pullTarget:
					(f = msg.getPullTarget()) && google_cloud_tasks_v2beta2_target_pb.PullTarget.toObject(includeInstance, f),
				rateLimits:
					(f = msg.getRateLimits()) && proto.google.cloud.tasks.v2beta2.RateLimits.toObject(includeInstance, f),
				retryConfig:
					(f = msg.getRetryConfig()) && proto.google.cloud.tasks.v2beta2.RetryConfig.toObject(includeInstance, f),
...
proto.google.cloud.tasks.v2beta2.Queue.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(3, f, google_cloud_tasks_v2beta2_target_pb.AppEngineHttpTarget.serializeBinaryToWriter);
	}
	f = message.getPullTarget();
	if (f != null) {
		writer.writeMessage(4, f, google_cloud_tasks_v2beta2_target_pb.PullTarget.serializeBinaryToWriter);
	}
	f = message.getRateLimits();
	if (f != null) {
		writer.writeMessage(5, f, proto.google.cloud.tasks.v2beta2.RateLimits.serializeBinaryToWriter);
	}
	f = message.getRetryConfig();
	if (f != null) {
		writer.writeMessage(6, f, proto.google.cloud.tasks.v2beta2.RetryConfig.serializeBinaryToWriter);
	}
	f = message.getState();
	if (f !== 0.0) {
...
proto.google.cloud.tasks.v2beta2.RetryConfig.prototype.getNumAttemptsCase = function () {
	return /** @type {proto.google.cloud.tasks.v2beta2.RetryConfig.NumAttemptsCase} */ (
		jspb.Message.computeOneofCase(this, proto.google.cloud.tasks.v2beta2.RetryConfig.oneofGroups_[0])
	);
};
	...
	proto.google.cloud.tasks.v2beta2.RetryConfig.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				maxRetryDuration:
					(f = msg.getMaxRetryDuration()) && google_protobuf_duration_pb.Duration.toObject(includeInstance, f),
